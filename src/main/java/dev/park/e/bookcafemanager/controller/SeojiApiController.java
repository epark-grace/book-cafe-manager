...
public class SeojiApiController {
    ...
    @GetMapping(value = "api/seoji-info", produces = "application/json; charset=utf-8")
    public ResponseEntity<HttpResponseBody> getBookByIsbn(@RequestParam("isbn") String isbn) {
