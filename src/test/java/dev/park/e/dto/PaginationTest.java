...
public class PaginationTest {
    ...
    void getTotalPage_generalCase(int totalRow, int totalPage) {
        Pagination pagination = new Pagination(totalRow, 1);
    ...
    void getTotalRow_totalRowIsRowLimitOrLess_returnOne(int totalRow, int totalPage) {
        Pagination pagination = new Pagination(totalRow, 1);
        assertEquals(totalPage, pagination.getTotalPage());
    }
    ...
    void getFirstPage_currentPageIsLastPage(int totalRow, int currentPage, int firstPage) {
        Pagination pagination = new Pagination(totalRow, currentPage);
        assertEquals(firstPage, pagination.getFirstPage());
    }
    ...
    void getLastPage_generalCase(int totalRow, int currentPage, int lastPage) {
        Pagination pagination = new Pagination(totalRow, currentPage);
    ...
    void getLastPage_lastPageIsAboveTotalPage(int totalRow, int currentPage, int lastPage, int totalPage, int newLastPage) {
        Pagination pagination = new Pagination(totalRow, currentPage);
    ...
    void getCurrentPage_currentPageIsAboveTotalPage(int totalRow, int currentPage, int totalPage, int newCurrentPage) {
        Pagination pagination = new Pagination(totalRow, currentPage);
